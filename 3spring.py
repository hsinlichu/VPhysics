...
spring2=helix(radius=0.015,thickness=0.01,color=color.red)
spring3=helix(radius=0.015,thickness=0.01)

wall_left.pos=vector(0,0,0)
wall_right.pos=vector(3*L,0,0)

ball.pos,ball.v,ball.m=vector(L,0,0),vector(0,0,0),m
ball2.pos,ball2.v,ball.m=vector(2*L,0,0),vector(0,0,0),m
spring.pos=wall_left.pos
spring2.pos=ball.pos
spring3.pos=ball2.pos

spring.axis=ball.pos-spring.pos
spring.axis2=ball2.pos-ball.pos
spring.axis3=wall_right.pos-ball2.pos
